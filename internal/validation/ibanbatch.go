// Package validation provides a batch validator for IBAN using the generic batch validation engine.
package validation
...
// IBANBatchValidator implements Validator for IBAN strings.
